...
const subscriptionTiers = [
  {
    ...
    features: [
      ...
      { text: "3 policy mappings/month", included: true },
      { text: "3 DSAR responses/month", included: true },
      { text: "Vendor assessments", included: false },
      { text: "AI Inventory & Risk Register", included: false },
      { text: "Board reports & AI analysis", included: false },
    ],
  ...
  },
  {
    ...
    features: [
      ...
      { text: "10 policy mappings + 5 incident assessments", included: true },
      { text: "AI Inventory (10 systems) + Risk Register (25)", included: true },
      { text: "Full privacy toolkit (DSAR, ROPA, DPA)", included: true },
      { text: "Board reports & AI analysis", included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "10 board reports/month", included: true },
      { text: "AI system analysis + risk analysis (25/mo)", included: true },
      { text: "50 policy mappings + 25 incident assessments", included: true },
      { text: "Unlimited risk entries", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Unlimited GRC tools & AI analysis", included: true },

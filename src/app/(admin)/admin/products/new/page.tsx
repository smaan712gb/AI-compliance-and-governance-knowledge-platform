          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Input id="slug" name="slug" required placeholder="product-slug" />
              </div>
            </div>
            <div>
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div>
                ...
                <select id="category" name="category" className="w-full rounded-md border border-input bg-background px-3 py-2 text-sm" required>
            ...
            <div>
              ...
              <Input id="stripePriceId" name="stripePriceId" placeholder="price_..." />
            </div>
